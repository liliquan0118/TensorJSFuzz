...
var tf=require("tfjs_source_code/tfjs/tfjs-4.1.0/tfjs-core/tfjs-core_pkg");
require("tfjs_source_code/tfjs/tfjs-backend-wasm/tfjs-backend-cpu_pkg");
require("tfjs_source_code/tfjs/tfjs-node")
...
async function diff_test(seed,operator,convert_tensor,dtype,varshape,count = null, obey = true, gen_script = false, save = false) {
    ...
    var browser_wasm_result = await puppeteer_browser_execute(browser_config0);
    ...
    var browser_webgl_result = await puppeteer_browser_execute(browser_config1);
