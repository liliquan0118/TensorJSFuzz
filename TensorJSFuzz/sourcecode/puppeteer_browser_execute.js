...
const options = {
    ...
    launch: {
        ...
        userDataDir: '/home/quanlili/Downloads/browserdata', // C:\BrowserData
        ...
        args: ['--remote-debugging-port=9222 ', 'enable-unsafe-webgpu', '--enable-webgl', '--use-gl', '--shm-size=3gb','--disable-dev-shm-usage','--enable-features=Vulkan'],
    },
    launch_firefox:
        {
            product: 'firefox',
    ...
    connect: {
        ...
        executablePath: '"/opt/google/chrome/google-chrome" --remote-debugging-address=0.0.0.0 --headless --use-gl --enable-unsafe-webgpu',
        ignoreHTTPSErrors: true,
        browserURL: 'http://172.30.144.1:9222',
    },
};
...
module.exports = puppeteer_browser_execute;
