...
function test(args) {
    ...
    async function main() {
        await loadScript("http://127.0.0.1:8080/tfjs-4.1.0/tfjs-core/tfjs-core_pkg/dist/tf-core.js");
        await loadScript("http://127.0.0.1:8080/tfjs-4.1.0-fsantize/tfjs-backend-wasm/tfjs-backend-wasm_pkg/dist/tf-backend-wasm.js");
        await loadScript("http://127.0.0.1:8080/tfjs-4.1.0/tfjs-backend-webgl/tfjs-backend-webgl_pkg/dist/tf-backend-webgl.js");
        await window['tf'];
        tf = window['tf'];
        let warnLogs = [];
        ...
        await tf.env().set('WASM_HAS_SIMD_SUPPORT', false);
            ...
            'tfjs-backend-wasm.wasm': 'http://127.0.0.1:8080/tfjs-4.1.0-fsantize/tfjs-backend-wasm/tfjs-backend-wasm_pkg/wasm-out/tfjs-backend-wasm.wasm',
                'tfjs-backend-wasm-simd.wasm': 'http://127.0.0.1:8080/tfjs-4.1.0-fsantize/tfjs-backend-wasm/tfjs-backend-wasm_pkg/wasm-out/tfjs-backend-wasm-simd.wasm',
                'tfjs-backend-wasm-threaded-simd.wasm': 'http://127.0.0.1:8080/tfjs-4.1.0-fsantize/tfjs-backend-wasm/tfjs-backend-wasm_pkg/wasm-out/tfjs-backend-wasm-threaded-simd.wasm'
        });
        var weights_dict;
        var operator;
        var input_array;
